...
- [`AD/Pwn/attack-defense-service/checker/`](../challenges/AD/Pwn/attack-defense-service/checker/)
  uses pinned pwntools to verify a platform-hosted raw TCP line service and its
  rotating flag.
- [`AD/Web/self-hosted-service/checker/`](../challenges/AD/Web/self-hosted-service/checker/)
...
In a second terminal from the same package:
...
Use the same environment for the self-hosted A&D package. For KotH, set
